  ...
  return (
    <div className='bg-teal-700 text-white sticky top-0 z-10'> 
      <nav className='max-w-4xl mx-auto p-4 flex justify-between items-center'>
        <Link to='/'><h1 className='text-4xl logo'>🌯 Great Burritos</h1></Link>
        ...
        <ul
          ...
          } transition-transform absolute top-0 left-0 w-full h-screen bg-zinc-800/80 flex flex-col justify-center items-center text-5xl`}
